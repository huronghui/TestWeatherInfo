...
//
//	    // e.g. "<sdcard>/Android/com.example.hrh.testweatherinfo.data/<package_name>/cache/"
//	    final File extCacheDir = new File(Environment.getExternalStorageDirectory(),
//	        "/Android/com.example.hrh.testweatherinfo.data/" + context.getApplicationInfo().packageName + "/cache/");
//	    extCacheDir.mkdirs();
//	    return extCacheDir;
